...
def test_customer_requests(driver, screenshot_manager, _data_index):
    ...
    try:
        ...
        with allure.step("Click on Customer Request Drop Down"):
         ...
         # Verification of Change of Billing Address for a Customer
        ...
        with allure.step("Verify Contract Details In the Customer 360 View"):
            ...
            screenshot_manager.add_screenshot(driver, "Customer  Account View")
            allure.attach(driver.get_screenshot_as_png(),
                          name="Customer Contract Account View",
                          attachment_type=allure.attachment_type.PNG)
